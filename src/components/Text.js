...
componentDidUpdate(){
  ...
  formatText = () =>{
    return(
      ...
      <p className='title-item'>{`${data.sir} ${data.firstName} ${data.lastName}`}</p>
      ...
      <p>
        I came across the Developer Intern opportunity on your company’s website. After viewing the position, requirements,
      ...
      <p>
        My path to becoming a web developer started when I was a teenager. I first started playing with static HTML pages and bash
